# nvim-treesitter-queries-purescript

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-purescript/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-purescript/actions/workflows/validate.yml)

Neovim tree-sitter queries for **purescript**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-purescript",
...
- [ ] Changes are scoped to `purescript` — do not include files for other languages
